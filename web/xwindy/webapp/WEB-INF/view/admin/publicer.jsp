...
<ol class="breadcrumb">
    ...
    <li><a href="/admin/studentlist">公众号用户管理</a></li>
    <li class="active">公众号用户信息编辑</li>
</ol>

<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">公众号用户信息编辑</h3>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>输入新密码</p>
                <input type="text" id="change-password" class="form-control"><br>
